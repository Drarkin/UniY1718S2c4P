...
extern	struct app_service_state {//indicates the system state 
		enum {Off,g_s,g_s_ok,s_s,s_s_ok,s_ds,s_ds_ok,joinR,joinR_ok,leave,leave_ok,ready,busy,w_ds,w_ds_ok,w_s,w_s_ok,On,s_s_ds,s_so_ds,s_so_dso} state; //have func getEnum
